...
import 'package:trips/presentation/controller/register_controller.dart';
...
class _RegisterScreenState extends ConsumerState<RegisterPage> {
  ...
  void _navigateToLogin() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => const LoginPage(skipLoading: true), // tanpa parameter tema
      ),
    );
  }
  ...
  void _navigateToLoginWithSnackbar(String email, String password) {
    ...
    if (mounted) {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => LoginPage(prefilledEmail: email, prefilledPassword: password, skipLoading: true),
        ),
      );
    }
  }
