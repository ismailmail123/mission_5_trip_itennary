...
import 'package:trips/presentation/pages/trip_map_screen.dart';
import 'package:trips/style/app_colors.dart';
import 'package:trips/style/font_style.dart';

class TripPlanPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TripPlanPage> createState() => _TripPlanScreenState();
}

class _TripPlanScreenState extends ConsumerState<TripPlanPage> {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_) => TripMapScreen(
                    destinationAddress: trip.location, // "Kyoto, Japan" dll
                  ),
                ),
              );
            },
            tooltip: 'Lihat rute ke lokasi',
          ),
        ],
      ),
