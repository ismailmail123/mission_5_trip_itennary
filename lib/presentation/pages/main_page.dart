...
import 'package:trips/presentation/pages/booking_page.dart';
import 'package:trips/presentation/pages/home_page.dart';
import 'package:trips/presentation/pages/dashboard_page.dart';
import 'package:trips/presentation/pages/manage_trips_page.dart';
import 'package:trips/presentation/pages/profile_page.dart';
...
class MainPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MainPage> createState() => _MainScreenState();
}
...
class _MainScreenState extends ConsumerState<MainPage> {
  ...
  void _navigateToManageTrips() {
    _navigateToScreen(const ManageTripsPage()); // tanpa tema
  }

  void _navigateToTripPlan(TripModel trip) {
    _navigateToScreen(TripPlanPage(trip: trip)); // tanpa tema
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (!isAuthenticated && _isInitialized) {
      return const LoginPage(); // tanpa tema
    }
