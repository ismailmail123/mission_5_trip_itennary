...
import 'package:trips/presentation/controller/search_controller.dart';
...
class SearchTripsPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SearchTripsPage> createState() => _SearchTripsScreenState();
}

class _SearchTripsScreenState extends ConsumerState<SearchTripsPage> {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => TripPlanPage(trip: trip),
          ),
        );
      },
      child: Container(
