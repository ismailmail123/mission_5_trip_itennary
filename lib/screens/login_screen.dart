...
//   final String? prefilledEmail;
//   final String? prefilledPassword;
//   final bool skipLoading; // ✅ TAMBAHKAN FLAG INI (default false)
//
//   const LoginScreen({
//     super.key,
//     required this.onThemeToggle,
...
//     this.prefilledEmail,
//     this.prefilledPassword,
//     this.skipLoading = false, // ✅ DEFAULT FALSE
//   });
//
//   @override
...
//     }
//
//     // ✅ TUNDA DENGAN WidgetsBinding (FIX ERROR RIVERPOD)
...
//         );
//
//         // ✅ JIKA SKIP LOADING, SET LOADING = FALSE
//         // INI ADALAH SATU-SATUNYA PERUBAHAN FUNGSIONAL
...
//     });
//
//     // Listener untuk update provider saat user mengetik
...
//
//   void _navigateToRegister() {
//     // ⚠️ TETAP MENGGUNAKAN setLoading(true) - SESUAI FUNGSI ASLI
...
//
//     // ⚠️ BUG: Navigasi dilakukan sebelum validasi (DIPERTAHANKAN SESUAI KODE ASLI)
//     Navigator.pushReplacementNamed(
//       context,
//       MainScreen.routeName,
//     );
...
//     await authController.login(loginState.email, loginState.password);
//
//     if (mounted) {
