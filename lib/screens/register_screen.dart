...
//     _showSuccessSnackBar('Registration successful! Your account has been created.');
//
//     final formState = ref.read(registerProvider);
...
//           'Login validation successful! You can now login with your credentials.',
//         );
//
...
//               prefilledEmail: email,
//               prefilledPassword: password,
//               skipLoading: true, // ✅ FLAG UNTUK SKIP LOADING
//             ),
//           ),
//         );
//       }
//     } else {
//       // ✅ TETAP LANGSUNG NAVIGASI TANPA DELAY
...
//       name: state.name,
//       email: state.email,
//       phone: '${state.selectedCountry.dialCode} ${state.phone}',
//       gender: state.gender,
...
//   }
//
//   Future<void> _processRegistration(RegisterRequest request) async {
...
//     }
//
//     final user = User.fromRegistration(
//       name: request.name,
//       email: request.email,
//       phone: request.phone,
