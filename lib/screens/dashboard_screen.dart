...
//     final trips = _tripService.getAllTrips();
//
//     return Scaffold(
...
//                           focusedBorder: InputBorder.none, // ⬅ saat diklik / input
...
//                             tapTargetSize: MaterialTapTargetSize.shrinkWrap, // ⬅ penting
...
//                             });
//
//                             // Helper function tanpa GlobalKey
//                             _showSnackBar(
//                               trip.isBooked ? 'Booking cancelled!' : 'Trip booked successfully!',
//                               backgroundColor: trip.isBooked ? Colors.red : Colors.green,
//                             );
...
//                                       _showSnackBar('Trip deleted', backgroundColor: Colors.red);
//                                     },
...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  // Data lists (static - tidak berubah)
  final List<Map<String, dynamic>> _topRatedDestinations = [
    {
      'title': 'EXPLORE',
      'location': 'Busan, South Korea',
